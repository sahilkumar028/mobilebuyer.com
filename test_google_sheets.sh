...
# Test Google Sheets API with curl
# Replace with your actual Google Apps Script URL

SCRIPT_URL="https://script.google.com/macros/s/AKfycbwrjIiXHiFJbivTU1bNZIdoe_rNdBxeDh9TzhmCWYb9i6gD3Jq3-Xa7f0wSfhS4AeFt/exec"
...
# Test 2: POST request with sell phone data (FormData format)
...
# Test 3: POST request with contact form data
...
# Test 4: POST request with invalid data to test error handling
