...
export const metadata: Metadata = {
  title: 'Contact Us - Get Instant Phone Quote | MobilesBuyer.com',
  description: 'Contact MobilesBuyer.com for instant phone quotes, professional refurbishment services, customer support, and all your second-hand phone needs in Delhi NCR.',
  ...
  openGraph: {
    title: 'Contact MobilesBuyer.com - Get Instant Quote for Your Phone',
  ...
  alternates: {
    canonical: 'https://MobilesBuyer.com/contact',
  },
};
